...
namespace Phantom{
	...
	//	unsigned int					color;
	//	float							fFrame;
	//	TypeArray<short>			textIndexs;	//文本索引值
	//};
	class PHANTOM_API  UIAnimationTrack: public Base
	{
	public:
		ImpComValue2();
		UIAnimationTrack();
	...
	class  PHANTOM_API UIControl: public ControlData
	{
	public:
	...
	public:
		...
		TypeArray<int>					m_textIndexs;	//文本索引值
	...
	public://
		...
		TypeArray<UIAnimationTrack*>	m_trackList;
	...
	class	 PHANTOM_API UIDrawMgr: public UISortBase
	{
	public:
		UIDrawMgr();
		~UIDrawMgr();
	...
	protected:
		TypeArray<UIDrawMgr*>	m_childs;	//子渲染列表
		TypeArray<int>	m_textIndexs;	//文本索引值
		int						m_textureID;
