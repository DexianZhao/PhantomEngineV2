...
#pragma pack(pop)
	...
	class	SceneObject;
	class PHANTOM_API SceneRenderBlood: public UISortBase
	{
	public:
	...
	class PHANTOM_API SceneObject: public MeshCallback
	{
	public:
		ImplementComValue();
	...
	class PHANTOM_API SceneGameSkill: public MeshCallback
	{
	public:
