...
#pragma pack(pop)
	...
	public:
		...
		bool					onNext();
		void					clearNext();
		static GameID			s_method;
		static GameID			s_actionindex;
		static GameID			s_toself;
		static GameID			s_health;
		static GameID			s_atk_speed;
		static GameID			s_hitmesh;
		int						m_content;
		char					m_visible;
		float					m_fHeight;
	...
	protected:
		...
		TypeArray<DataVal>		m_vals;//自定义变量列表
		struct	EventVal{
			char				eventid;
			Name				func;
		};
		TypeArray<EventVal>		m_events;//事件绑定列表
		char					m_state;//AI状态
		//
	...
	class	PHANTOM_API GameLeader: public GameObject
	{
	public:
