...
#pragma pack(pop)
	...
	class PHANTOM_API  UVAnimation: public UVAnimationData
	{
	public:
	...
	public:
		...
		TypeArray<TextureRectUV>		m_rects;
	};
	class UIDialog;
	class UIControl;
	class UIElement;
	...
	class PHANTOM_API  UIElement: public ElementData
	{
	public:
...
//		VOID					SetElementNameA(const char* szName){m_name = szName;}
		...
		TypeArray<UVAnimation*>	m_uvAnimations;
