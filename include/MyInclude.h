...
PHANTOM_API int		OnAppInputEvent(int nEvent, int x, int y, unsigned int touchIndex);
...
PHANTOM_API void    UpdateMotion(float gravityX,float gravityY,float gravityZ, float zTheta, float xyTheta, float rotationRateX, float rotationRateY,float rotationRateZ,
