...
#pragma pack(push,1)
	...
	class	PHANTOM_API GameTableBase
	{
	public:
		GameID			m_id;
...
#pragma pack(pop)
template <int Tindex>
	class PHANTOM_API lua_GameTable: public GameTableBase{
	public:
	...
	//AI事件类
	class	PHANTOM_API AIScript: public ScriptBase{
	public:
	...
	//游戏技能类,脚本+表格驱动
	class	PHANTOM_API SkillScript: public ScriptBase{
	public:
	...
	//游戏任务类,脚本+表格驱动
	class	PHANTOM_API MissionScript{
	public:
	};

	//游戏特效类,脚本+表格驱动
	class	PHANTOM_API EffectScript{
	public:
	};
	class	PHANTOM_API SceneScript: public ScriptBase
	{
	public:
		SceneScript(){}
		virtual ~SceneScript(){}
