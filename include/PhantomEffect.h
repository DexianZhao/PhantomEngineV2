...
class  PHANTOM_API EffectMeshFrame
{
public:
	EffectMeshFrame();
	void Release();
...
public:
	...
	virtual void Draw(TypeArray<AotmicData*>& vAtomic, EffectNode* node){}
};


class  PHANTOM_API AtomicLine : public AtomicBase
{
public:
	EffectLine	m_line;
	Texture*	m_pTex;
...
class  PHANTOM_API AtomicPlane : public AtomicBase
{
public:
	Texture*		m_pTex;
public:
...
class  PHANTOM_API AtomicMesh : public AtomicBase
{
public:
	virtual void DestroyAtomic(AotmicData* pAtomic);
	virtual AotmicData* CreateAtomic(SProperty* pPro);
...
class SkillBase;
class  PHANTOM_API EffectNode : public AotmicData
{
public:
	SProperty			m_pPro;
	TypeArray<EffectNode*>		m_vNodeInst;
	TypeArray<AotmicData*>		m_vNodeActive;
...
class Effect;
class  PHANTOM_API EffectRender: public RenderBase
{
public:
...
class  PHANTOM_API Effect : public EffectNode
{
public:
...
class  PHANTOM_API EffectManager
{
public:
	void						Render();
	void						FrameMove();
...
protected:
	TypeArray<EffectMesh*>	m_meshs;
	TypeArray<Effect*>		m_effectLoads;
	TypeArray<Effect*>		m_effectRuntimes;
	std::vector<AtomicBase*>	m_vAtomicInst;
	int							m_nCreateID;
};

PHANTOM_API VOID							CreateEffectMgr();
PHANTOM_API EffectManager*					GetEffectMgr();
PHANTOM_API VOID							ReleaseEffectMgr();
